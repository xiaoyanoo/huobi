<?php
	...
	$url = 'index.php?kk&c=user&p=';//定义页码url
	...
	$res = select_all('user.*,privilege.id,privilege.pri_name','user','','c_time desc',"$ss,$n",'left join privilege on user.pid = privilege.id');
